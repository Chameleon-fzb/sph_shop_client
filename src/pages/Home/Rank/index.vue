  ...
  <div class="rank">
    <div class="tab">
      <div class="tab-tit clearfix">
        <a href="javascript:;" v-for="(rank, index) in ranks" :key="index" :class="{ on: isClicked === index }"
          @click="isClicked = index">
          <p class="img">
            <i></i>
          </p>
          <p class="text">{{ rank.text }}</p>
        </a>
      </div>
    ...
    <div class="content">
      <ul>
        <!-- <li v-if="ranks[isClicked]">
          <div class="img-item" v-for="(rankItem, index) in rank[isClicked].rankList" :key="index">
            <p class="tab-pic">
              <a href="#">
