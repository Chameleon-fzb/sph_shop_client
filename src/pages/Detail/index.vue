    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :imgList="imageList" :currentIndex="imgIndex" />
          <!-- 小图列表 -->
          <ImageList :imgList="imageList" @changeImgIndex="changeImgIndex" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="	spuSaleAttr in 	spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" :class="{ active: attrValue.isChecked === '1' }"
                  v-for="(attrValue, index) in spuSaleAttr.spuSaleAttrValueList" :key="attrValue.id"
                  @click="changeIsChecked(attrValue, spuSaleAttr.spuSaleAttrValueList)">
            ...
            <div class="cartWrap">
              <div class="controls">
                ...
                <a href="javascript:" class="plus" @click="changeSkuNum(1)">+</a>
...
export default {
  ...
  methods: {
    ...
    //  改变商品数量
    changeSkuNum(num) {
      let value = num > 0 ? this.skuNum + 1 : this.skuNum - 1
      !(value > 1) && (value = 1)
      value > 99 && (value = 99)
      this.skuNum = value
    },
    ...
    //属性选中
    changeIsChecked(currentAttrValue, spuSaleAttrValueList) {
